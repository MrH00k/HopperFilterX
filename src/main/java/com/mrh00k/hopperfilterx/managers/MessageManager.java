...
public class MessageManager {
  ...
  private void loadDefaultMessages() {
    ...
    // Add permission command messages
    ...
    messages.put("command.addperm-no-hoppers", "&cYou do not own any filtered hoppers.");

    // Remove permission command messages
    ...
    messages.put("command.removeperm-no-hoppers", "&cYou do not own any filtered hoppers.");
    ...
    // Message for denied insertion into filtered hopper
    messages.put(
        "hopper.filter-denied", "&cThis hopper has a filter, you cannot insert this item.");
    messages.put(
        "hopper.config-opening", "&eOpening filter configuration... (GUI not implemented yet)");

    // Error messages
    messages.put("error.give-failed", "&cFailed to give hopper to player {player}.");
    messages.put(
        "error.unexpected",
        "&cAn unexpected error occurred: {error}"); // Default messages for /hopper list command
    ...
    messages.put("command.list-entry-placed", "&ePlaced at {world} @ {x},{y},{z}");
    messages.put("command.list-entry-inventory", "&eIn inventory");
